...
from legacy_nycdb_importer.nycdb_repo import ensure_nycdb_repo
from legacy_nycdb_importer.report import MigrationReport
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=_REPO_ROOT,
        help="Definition repo root; writes import_drafts/ and import_reports/ (default: this repo)",
    )
    parser.add_argument(
        "--nycdb-repo",
        type=Path,
