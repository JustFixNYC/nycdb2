...
from legacy_nycdb_importer.map_types import build_field_type_index, map_legacy_type
from legacy_nycdb_importer.parse_legacy import LegacyTableSchema
from legacy_nycdb_importer.shapefile_headers import (
...
def build_columns_from_fields_only(table: LegacyTableSchema) -> ColumnBuildResult:
    """Fallback when integration sample CSV is missing (e.g. shapefile-only tables)."""
    warnings = [
